...
const aboutDetails = [
  `Chào mừng đến với iGrow - Nền tảng trao quyền kỹ năng số và tư duy khởi nghiệp cho thanh niên dân tộc thiểu số! Dự án iGrow ra đời từ chính những trăn trở và hoạt động thực tiễn của nhóm tại vùng Đồng bằng sông Cửu Long. `,
  `Qua quá trình làm việc trực tiếp với thanh niên các dân tộc Khmer, Hoa, Chăm tại Cần Thơ, Sóc Trăng, Trà Vinh, An Giang, chúng tôi nhận thấy một nhu cầu cấp thiết về việc nâng cao kỹ năng số và tư duy khởi nghiệp.  Để giải quyết bài toán này, iGrow được xây dựng thành một giải pháp giáo dục, hiện thực hóa qua ứng dụng di động ưu tiên hoạt động ngoại tuyến và tích hợp Trí tuệ nhân tạo. `,
  `Mục tiêu của iGrow là cung cấp các chương trình đào tạo cá nhân hóa, phù hợp với văn hóa và điều kiện đặc thù của thanh niên dân tộc thiểu số tại Đồng bằng sông Cửu Long và tiến tới mở rộng ra cả nước.  Chúng tôi tập trung vào việc thu hẹp khoảng cách số và thúc đẩy bình đẳng cơ hội, qua đó giúp thanh niên dân tộc thiểu số tự tin hội nhập vào nền kinh tế số và hướng tới phát triển bền vững. `,

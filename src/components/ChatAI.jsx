...
function ChatAI() {
  ...
  const handleSendMessage = async () => {
    if (input.trim()) {
      ...
      try {
        ...
        setLoading(false);
        setMessages([...newMessages, { text: 'Lỗi: Không thể nhận phản hồi từ AI', user: false }]);
      }
    }
  };
  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center h-screen bg-gradient-to-r from-green-400 to-blue-500">
      <h1 className="mb-8 font-bold text-[3rem] drop-shadow-lg text-blue-50">AI AN TOÀN GIAO THÔNG</h1>
